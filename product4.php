...
<head>
    ...
    <title>Product Details - AI-Generated Content Services</title>
...
<body>
    ...
    <section class="product-details">
        <h2 name="NAME" id="NAME">AI-Generated Content Services</h2>
        <img src="assets/AI.png" alt="AI-Generated Content Services">
        <p>Description of the product: Harness the power of artificial intelligence to elevate your content creation process with our cutting-edge AI-Generated Content Services.</p>
        <p>Price: $<span nam="PRICE" id="PRICE">150</span></p>
        <form action="product4.php" method="POST">
        <input type="hidden" name="NAME" value="AI-Generated Content Services">
