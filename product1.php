...
<head>
    ...
    <title>Product Details - Digital Tools & Software</title>
...
<body>
    ...
    <section class="product-details">
        <h2 name="NAME" id="NAME">Digital Tools & Software</h2>
        <img src="assets/phone.png" alt="Digital Tools & Software">
        <p>Description of the product: This is a collection of top-quality digital tools and software to enhance your productivity.</p>
        <p>Price: $<span nam="PRICE" id="PRICE">199</span></p>
        <form action="product1.php" method="POST">
        <input type="hidden" name="NAME" value="Digital Tools & Software">
